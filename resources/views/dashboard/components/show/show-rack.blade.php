...
@section('contents')
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Rack</h6>
            ...
            <div class="card" id="editForm" style="display: none;">
                <div class="card-body">
                    <form action="{{ route('update.rak', $rack->id) }}" method="POST" class="row gy-3">
                        @csrf
                        @method('PUT')
                        <input type="text" name="id" value="{{ $rack->id }}">
                        <div class="col-md-6">
                            <label class="form-label">Input with Placeholder</label>
                            <input type="text" name="code_rack" value="{{ $rack->code_rack }}" class="form-control"
                                required />

                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Input with Placeholder</label>
                            <input type="text" name="name_rack" value="{{ $rack->name_rack }}" class="form-control"
                                required />
